...
INSTALLATION
Place the complete "diudiubear_modular_awm" folder in ZERO Sievert's local mods directory, enable it in the Mod Manager, and reload mod data.

COMPATIBILITY
Internal IDs start with wz_ddb_.
